export function getDetails (configs) {
    ...
    if(configs && configs.length) {
        configs.forEach(conf=>{
            ...
            config.companyLandLine1 = conf.ConfigGroup === 'FIRM' && conf.Config === 'LANELINE1' ? conf.Value:config.companyLandLine1;
            ...
            config.companyMobile1 = conf.ConfigGroup === 'FIRM' && conf.Config === 'MOBILE2' ? conf.Value:config.companyMobile2;
